...
var globalFetch =
  ...
  (typeof global !== "undefined" && global.fetch); // eslint-disable-next-line global-require
...
var HttpLogger = /*#__PURE__*/ (function (_EventEmitter) {
  ...
  function HttpLogger(_ref) {
    ...
    var endpoint = _ref.endpoint,
      ...
      fetchImplementation =
        _ref$fetchImplementat === void 0
          ? defaultFetchImpl
          : _ref$fetchImplementat;
  ...
  _createClass(HttpLogger, [
    ...
    },
    {
      ...
      value: function on() {
        ...
        _get(_getPrototypeOf(HttpLogger.prototype), "on", this).apply(
          this,
          args
        );
      },
    },
    {
      ...
      value: function logSpan(span) {
        ...
        if (
          this.maxPayloadSize &&
          this._getPayloadSize(encodedSpan) > this.maxPayloadSize
        ) {
          ...
          if (this._getPayloadSize(encodedSpan) > this.maxPayloadSize) {
            ...
            var err =
              "[@] gatsby-plugin-newrelic: Span got dropped, reason: payload too large";
      ...
      value: function processQueue(fetchImpl) {
        ...
        if (self.queue.length > 0 && options.NR_INGEST_KEY && options.traces.collectTraces) {
          const formattedQueue = self.queue.map((trace) => {
            ...
            formatTrace.tags.gatsbySite = options.SITE_NAME;
